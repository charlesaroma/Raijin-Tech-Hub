  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="mb-12 p-6 rounded-2xl bg-white/90 backdrop-blur-xl border border-gray-100 shadow-xl"
      >
        <p className="text-(--color-text-secondary) leading-relaxed">
          Welcome to Raijin Tech Hub. These Terms of Service (&quot;Terms&quot;)
          constitute a legally binding agreement between you (the
          &quot;Client&quot;) and Raijin Tech Hub (the &quot;Company&quot;,
          &quot;we&quot;, &quot;us&quot;, or &quot;our&quot;). By accessing our
          website or engaging our services, you acknowledge that you have read,
      ...
      <div className="space-y-8">
        {sections.map((section, index) => (
          <div
            ...
            className="group relative rounded-3xl p-8 bg-white/80 backdrop-blur-md border border-gray-100 transition-all duration-300 shadow-lg hover:shadow-2xl hover:-translate-y-1"
          >
            {/* Icon & Title */}
            <div className="flex items-start gap-4 mb-6">
              <div className="w-16 h-16 rounded-xl bg-(--color-primary-50) text-(--color-tertiary-500) flex items-center justify-center shrink-0 border border-gray-100 group-hover:scale-105 transition-transform">
                {section.icon}
              </div>
              <h2 className="text-2xl lg:text-3xl font-bold text-(--color-primary-600) pt-3">
                {section.title}
              </h2>
            </div>
            ...
            <div className="sm:pl-20">
              <div className="text-(--color-text-secondary) leading-relaxed whitespace-pre-line">
                {section.content}
              </div>
            </div>
          </div>
      ...
      <div className="mt-8 space-y-8">
        {/* Termination */}
        <div className="p-8 rounded-3xl bg-white/80 backdrop-blur-md border border-gray-100 shadow-lg">
          <h2 className="text-2xl font-bold text-(--color-primary-600) mb-4">
            Termination
          </h2>
          <p className="text-(--color-text-secondary) leading-relaxed">
            Either party may terminate a project agreement with 30 days written
            notice. Upon termination, you must pay for all work completed up to
            the termination date. We reserve the right to immediately terminate
            services for breach of these Terms, non-payment, or illegal
            activities. Upon termination, we will provide all work completed to
            date, and you will retain license to use delivered components per
            the agreed terms.
          </p>
        </div>
        ...
        <div className="p-8 rounded-3xl bg-white/80 backdrop-blur-md border border-gray-100 shadow-lg">
          ...
          <p className="text-(--color-text-secondary) leading-relaxed mb-4">
            ...
            arising from these Terms or our services, the parties agree to first
            attempt resolution through good faith negotiations. If unresolved
            within 30 days, disputes shall be submitted to mediation in Kampala,
            Uganda.
          </p>
          <p className="text-(--color-text-secondary) leading-relaxed">
            <strong>Jurisdiction:</strong> If mediation fails, disputes shall be
            subject to the exclusive jurisdiction of the courts of Uganda, and
            both parties consent to the jurisdiction and venue of such courts.
          </p>
        </div>
        ...
        <div className="p-8 rounded-3xl bg-white/80 backdrop-blur-md border border-gray-100 shadow-lg">
          ...
          <p className="text-(--color-text-secondary) leading-relaxed">
            You agree to indemnify, defend, and hold harmless Raijin Tech Hub,
            its officers, directors, employees, and agents from any claims,
            damages, losses, liabilities, and expenses (including reasonable
            attorneys' fees) arising from: (a) your use of our services, (b)
            your breach of these Terms, (c) your violation of any law or rights
            of a third party, or (d) content or information you provide to us.
          </p>
        </div>
        ...
        <div className="p-8 rounded-3xl bg-white/80 backdrop-blur-md border border-gray-100 shadow-lg">
          ...
          <p className="text-(--color-text-secondary) leading-relaxed">
            ...
            project-specific agreements and our Privacy Policy, constitute the
            entire agreement between you and Raijin Tech Hub regarding our
        ...
        {/* Contact Information */}
        <div className="p-8 rounded-3xl bg-(--color-primary-600) text-center shadow-xl text-white">
          ...
          <div className="space-y-2">
            <p>
              <strong>Email:</strong> raijintechug@gmail.com
            </p>
            <p>
              <strong>Phone:</strong> +256 777 982 066
            </p>
            <p>
