...
const Navbar = () => {
  ...
  return (
    <nav className="w-full h-[10vh] lg:h-[13vh] fixed z-10 top-0 flex items-center justify-between px-4 md:px-6 lg:px-[5%] shadow-md bg-[var(--color-accent-500)] overflow">
      {/* Logo Section */}
