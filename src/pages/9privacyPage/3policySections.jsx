    ...
    <>
      ...
      >
        <p className="text-(--color-text-secondary) leading-relaxed">
          Raijin Tech Hub (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;)
          respects your privacy and is committed to protecting your personal
          data. This privacy policy complies with the Ugandan Data Protection
          and Privacy Act and international standards including GDPR principles.
          By using our services or website, you agree to the collection and use
      ...
      <div className="mt-8 space-y-8">
        ...
        <div className="p-8 rounded-3xl bg-white/80 backdrop-blur-md border border-gray-100 shadow-lg">
          ...
          <p className="text-(--color-text-secondary) leading-relaxed">
            ...
            When your data is no longer required, we securely delete or
        ...
        <div className="p-8 rounded-3xl bg-white/80 backdrop-blur-md border border-gray-100 shadow-lg">
          ...
          <p className="text-(--color-text-secondary) leading-relaxed">
            ...
            located outside of Uganda. We ensure that such transfers comply with
            applicable data protection laws and that appropriate safeguards are
            in place to protect your personal information, including standard
