    ...
    <>
      ...
      <section className="relative w-full min-h-screen py-16 px-4 md:px-6 lg:px-[5%] bg-transparent overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-40 -left-20 w-72 h-72 bg-(--color-primary-500)/10 rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute bottom-40 -right-20 w-96 h-96 bg-(--color-primary-600)/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
        </div>
